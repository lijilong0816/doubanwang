...
import com.chenyc.douban.MiniBlogActivity.BackButtonListener;
import com.chenyc.douban.MiniBlogActivity.EditButtonListener;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				...
				intent.putExtra("url", topicList.get(arg2+1).getUrl());
				intent.putExtra("title", topicList.get(arg2+1).getTitle());
	...
	public void fillData()
	{
		new AsyncTask<Void,Void,List<Topic> >()
		{
			...
			protected void onPostExecute(List<Topic> result) {
				...
				if(result!=null)
				{
					if(listAdapter==null)
					{
						...
						listAdapter = new SimpleAdapter(TopicListActivity.this, list,
								R.layout.topic_item, new String[] { "topic_name","topic_reply",
								"topic_time", "topic_title" }, new int[] {
								R.id.topic_writer,R.id.topic_reply, R.id.topic_time,R.id.topic_title});
				...
				{
					Toast.makeText(TopicListActivity.this, "数据加载失败", Toast.LENGTH_SHORT);
				}
				//撤销加载框
				pd.dismiss();
			}
...
//加载对话框
 ...
 {
	pd=ProgressDialog.show(TopicListActivity.this, "信息", "加载数据中..."); 
 }
